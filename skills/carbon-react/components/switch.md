...
| loading | boolean \| undefined | No |  |  |  | Triggers loading animation |  |
...
| value | string \| undefined | No |  |  |  | The value of the switch, passed on form submit |  |
...
| validationMessagePositionTop | boolean \| undefined | No |  |  |  | Render the ValidationMessage above the Switch input when validationRedesignOptIn flag is set |  |
