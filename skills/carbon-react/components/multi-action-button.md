---
name: carbon-component-multi-action-button
description: Carbon MultiActionButton component props and usage examples.
---
...
- Props interface: `MultiActionButtonProps`
...
### With Children Buttons With Icons
