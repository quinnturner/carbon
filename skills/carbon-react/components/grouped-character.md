---
name: carbon-component-grouped-character
description: Carbon GroupedCharacter component props and usage examples.
---
...
- Props interface: `GroupedCharacterProps`
- Deprecated: Yes
- Deprecation reason: `GroupedCharacter` has been deprecated. See the Carbon documentation for migration details.
