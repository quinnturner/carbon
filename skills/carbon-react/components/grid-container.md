---
name: carbon-component-grid-container
description: Carbon GridContainer component props and usage examples.
---
...
- Props interface: `GridContainerProps`
- Deprecated: Yes
- Deprecation reason: `GridContainer` has been deprecated. See the Carbon documentation for migration details.
