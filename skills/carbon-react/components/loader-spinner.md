...
| variant | "gradient-grey" \| "gradient-white" \| "inverse" \| "action" \| "neutral" \| undefined | No |  | The variant prop can be used to change the appearance of the component. Typically both the outer and inner spinner will change color, however there will still be sufficient contrast between them | "action" |
