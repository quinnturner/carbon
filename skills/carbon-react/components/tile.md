...
## Import
`import { Tile } from "carbon-sage/lib/components/tile";`
...
| roundness | "large" \| "small" \| "default" \| undefined | No |  | Sets the level of roundness of the corners, "default" is 8px, "large" is 16px and "small" is 4px | "default" |
