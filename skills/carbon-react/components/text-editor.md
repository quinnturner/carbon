...
| footer | import("/Users/quinnturner/Dev/Sage/carbon/node_modules/@types/react/index").ReactNode | No |  |  |  | Custom footer content to be displayed below the editor |  |
| header | import("/Users/quinnturner/Dev/Sage/carbon/node_modules/@types/react/index").ReactNode | No |  |  |  | Custom header content to be displayed above the editor |  |
...
| previews | import("/Users/quinnturner/Dev/Sage/carbon/node_modules/@types/react/index").JSX.Element[] \| undefined | No |  |  |  | An array of link preview nodes to render in the editor |  |
...
| customPlugins | import("/Users/quinnturner/Dev/Sage/carbon/node_modules/@types/react/index").ReactNode | No |  |  |  | Allows the injection of one or more Lexical-compatible React components into the editor to extend its functionality. This prop is optional and supports a single plugin, multiple plugins (via fragments or arrays), or `null`. |  |
